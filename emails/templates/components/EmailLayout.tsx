        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.footer}>
            ...
            <Text style={styles.footerLinks}>
              <Link href="https://github.com/yourusername/launch-mvp-stripe-nextjs-supabase" style={styles.footerLink}>
                GitHub
              </Link>
              {' • '}
              <Link href="https://www.youtube.com/@yourchannel" style={styles.footerLink}>
                YouTube
              </Link>
              {' • '}
              <Link href="https://x.com/yourusername" style={styles.footerLink}>
                X/Twitter
              </Link>
            </Text>
          </Section>
