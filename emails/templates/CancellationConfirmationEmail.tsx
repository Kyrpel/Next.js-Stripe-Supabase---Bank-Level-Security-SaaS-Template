      ...
      <EmailLayout previewText="Your account has been deleted.">
        <Section style={styles.mainSection}>
          ...
          <Section style={styles.ctaSection}>
            <Button href="https://github.com/yourusername/launch-mvp-stripe-nextjs-supabase" variant="dark">
              Visit GitHub
            </Button>
          </Section>
        </Section>
    ...
    <EmailLayout previewText={`Hey ${firstName}, we'd love to have you back! Your subscription can be reactivated anytime.`}>
      ...
      <Section style={styles.footerSection}>
        <Text style={styles.footerLinks}>
          <Link href="https://github.com/yourusername/launch-mvp-stripe-nextjs-supabase/issues" style={styles.footerLink}>
            Report issues
          </Link>
          {' • '}
